...
public class success extends AppCompatActivity {
    ...
    public String responseURL = "http://140.113.72.125/lab01230322/response_firestation.php";
        ...
        GPS.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(reportID.equals("0")) { //沒按下接收案件按鈕或是目前無分配之任務
                    ...
                    // 呼叫讀取偏好資料
                    readPref();
                    Toast.makeText(success.this, "結束導航後請按返回鍵回到消防APP", Toast.LENGTH_SHORT).show();
                    jumpTo_GPS();
        ...
        arrive.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(attendanceInt > 0){
                    ...
                    intent.putExtra("fireID", fireID);
                    intent.putExtra("fireSTID", fireSTID);
