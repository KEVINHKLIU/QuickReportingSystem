package app.tomlai.com.policereportingsystem;
...
public class success extends AppCompatActivity  {
    ...
    public String responseURL = "http://140.113.72.125/lab01230322/response_police.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        policeSTID = intent.getStringExtra("policeSTID");
        ...
        receive.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                receiveReport();// 按下接收案件（傳警察ID, 收案件 + 案件ID）
        ...
        GPS.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                // 呼叫讀取偏好資料
                readPref();
                Toast.makeText(success.this, "結束導航後請按返回鍵回到警務APP", Toast.LENGTH_SHORT).show();
                jumpTo_GPS();
        ...
        attendance.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (!reportID.equals("0") && attendanceInt == 0) {   //沒有案件
        ...
        arrive.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (attendanceInt > 0) {
                    ...
                    intent.setClass(success.this, finish.class);
                    intent.putExtra("policeID", policeID);
                    intent.putExtra("policeSTID", policeSTID);
    ...
    public void receiveReport(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, responseURL,    // http://140.120.13.252:8081/fuck/catchapp.php
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("username", policeSTID);
                map.put("password", policeID);
                return map;
            }
        };
    ...
    public void reportArriveTime(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, responseURL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(success.this, "已通報抵達現場時間: " + time, Toast.LENGTH_LONG).show();
