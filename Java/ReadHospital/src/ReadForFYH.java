...
public class ReadForFYH {
	...
	public  void readFromText()
	{
		...
		try   //檔案讀寫的函示
		{
			fileIn = new Scanner(new FileInputStream("豐原醫院.txt")); //去讀檔案,我的檔案名稱是teamInfo.txt
		}
	...
	public void insertToDatabase()
	{
		...
		for(int i = 0; i < numOfTerm; i++)
			intoDatabase.insertTable("衛生福利部豐原醫院", wardType[i], beds[i], occupancyBeds[i], noAvailableBeds[i]);
	}
